...
class Fonts {
	 ...
	 */
	public const GOOGLE = 'googlefonts';
	...
	private function load_hook() {
		add_filter( 'elementor/fonts/additional_fonts', array( $this, 'get_fonts' ) );
	}
	 ...
	 * @return array
	 */
	public static function get_fonts( $additional_fonts = array() ) {
		$fonts = array(
			'Arial'           => self::SYSTEM,
			'Tahoma'          => self::SYSTEM,
			'Verdana'         => self::SYSTEM,
		...
		/** Google Fonts (last update: 21/06/2023) */
		$google_fonts = array(
			'ABeeZee'                          => self::GOOGLE,
			'Abel'                             => self::GOOGLE,
			...
			'Noto Kufi Arabic'                 => self::GOOGLE,
			'Noto Music'                       => self::GOOGLE,
			'Noto Naskh Arabic'                => self::GOOGLE,
		...
		$fonts = array_replace( $fonts, $additional_fonts );
	 ...
	 */
	public static function get_formated_font_list() {
